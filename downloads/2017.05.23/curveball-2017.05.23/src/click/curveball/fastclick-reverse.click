...
reverse_ip_classifier :: IPClassifier(src tcp port $TLS_PORT,
...
// IPv4 traffic
forward_classifier[0] -> Strip(14) -> MarkIPHeader() -> forward_ip_classifier;
reverse_classifier[0] -> Strip(14) -> MarkIPHeader() -> reverse_ip_classifier;
...
// everything else
forward_ip_classifier[4] -> Unstrip(14) -> forward_outgoing;
reverse_ip_classifier[3] -> Unstrip(14) -> reverse_outgoing;
