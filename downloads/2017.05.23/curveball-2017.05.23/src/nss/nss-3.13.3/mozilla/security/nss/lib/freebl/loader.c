...
curveball_aes_set_context(AESContext *enc)
{
    ...
    return vector->p_curveball_aes_set_context(enc);
}
...
curveball_aes_set_key(const unsigned char *key, unsigned int keysize)
{
    ...
    return vector->p_curveball_aes_set_key(key, keysize);
}
...
curveball_aes_get_iv(void)
{
    ...
    return vector->p_curveball_aes_get_iv();
}
...
curveball_aes_get_key(unsigned int *keysize)
{
    ...
    return vector->p_curveball_aes_get_key(keysize);
}
/* end CURVEBALL */
