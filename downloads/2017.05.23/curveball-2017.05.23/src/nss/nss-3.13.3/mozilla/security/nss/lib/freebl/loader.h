...
struct FREEBLVectorStr {
 ...
 /* CURVEBALL */
 int (* p_curveball_aes_set_context)(AESContext *enc);
 int (* p_curveball_aes_set_key)(const unsigned char *key,
	 unsigned int keysize);

 const unsigned char *(* p_curveball_aes_get_iv)(void);
 const unsigned char *(* p_curveball_aes_get_key)(unsigned int *keysize);
 /* end CURVEBALL */
